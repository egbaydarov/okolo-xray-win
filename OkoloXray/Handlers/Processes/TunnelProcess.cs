...
namespace OkoloXray.Handlers.Processes
{
    using Foundation;
    using Services;
    using Models;
    ...
    public class TunnelProcess
    {
        ...
        private const string OKOLO_TUN_PROCESS = "okolo-TUN";
        ...
        public void Start()
        {
            ...
            processor.StopSystemProcesses(OKOLO_TUN_PROCESS);

            processor.StartProcess(
                processName: OKOLO_TUN_PROCESS,
                fileName: System.IO.Path.GetFullPath(Path.OKOLO_TUN_EXE),
        ...
        public bool IsProcessRunning() => processor.IsProcessRunning(OKOLO_TUN_PROCESS);
