namespace OkoloXray.Values
{
    public static class Route
    {
        public const string WEBSITE = "https://okolo.io";
        public const string EMAIL = "mailto:customer@okolo.io";
        public const string REPOSITORY = "https://github.com/egbaydarov/okolo-xray-win";
